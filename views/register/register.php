      ...
      <form class="form-signin" action="/register" method="POST">       
        <h5 class="form-signin-heading plogin">Registre</h5>
          ...
          <?php
           if($securityPassword)  :?>
            <div class="alert alert-warning" role="alert">
                <a href="#" class="alert-link">Les contrasenyes no coincideixen</a>
            </div>
          <?php endif; ?>
        ...
        <input id="login_password2" type="password" class="form-control" name="password2" placeholder="Repeteix la contrasenya" required=""/><br>
        <input id="login_email" type="text" class="form-control" name="email" placeholder="Email" required=""/><br>            
